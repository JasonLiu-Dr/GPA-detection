...
from model.adaptive_faster_rcnn.faster_rcnn import _fasterRCNN
...
class resnet(_fasterRCNN):
  def __init__(self, classes, num_layers=101, pretrained=False, class_agnostic=False, mode='adapt', rpn_mode = 'adapt'):
    ...
    _fasterRCNN.__init__(self, classes, class_agnostic, mode, rpn_mode)
